...
<section id="projects" class="bg-base-alpha section-diagonal w-full px-6">
	<div class="mx-auto max-w-5xl">
		<h2 class="reveal mb-2 text-center text-4xl font-bold text-text" use:inview>Projects</h2>
